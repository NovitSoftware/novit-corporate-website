/* ==========================================================================
   ...
   `casesContent` in `@/shared/content/cases`, which two other routes render
   too. The indices below are kept in step with `_components/HomePage.tsx` by
 ...
 *
 * Getting to them is the menu's job — `@/shared/content/navigation`, one entry
 ...
 * contact section is the close now. See `_components/HomePage.tsx`.
 */
